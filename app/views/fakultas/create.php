            ...
            <form role="form" action="<?= base_url; ?>/fakultas/simpanFakultas" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan nama fakultas..." name="NamaFakultas">
                    </div>
                    <div class="form-group">
                        <label>Alamat Fakultas</label>
                        <textarea class="form-control" placeholder="Masukkan alamat fakultas..." name="AlamatFakultas"></textarea>
                    </div>
                    <div class="form-group">
